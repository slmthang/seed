...
export function Icon({className, onClick, children} : {className: string, onClick?: any, children: React.ReactNode}) {
...
export function MenuBar() {
    ...
    return (
        <nav className="z-10 flex justify-center items-center w-screen h-14 sticky top-px bg-darkest">
            <Icon className="w-6 absolute left-px ml-5">
            ...
            <Icon className="w-6 absolute right-px mr-5">
    ...
    const  NavBarOptionsData = [
        {
            path: '/overview',
            icon: (
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" className="size-6 stroke-lightest stroke-1.5 stroke-inherit">
