...
// local
import { groupByType, orderByType, sortByType } from '@/app/lib/definitions';
import { ChevronDownIcon, ChevronRightIcon } from '@/app/ui/Icons';
    ...
    return (
        <div>
            ...
            >
                ...
                {!showOptions && (
                    <ChevronRightIcon tailwindClass="absolute right-[1rem] stroke-2" />
                )}
                {showOptions && (
                    <ChevronDownIcon tailwindClass="absolute right-[1rem] stroke-2" />
                )}
            </div>
