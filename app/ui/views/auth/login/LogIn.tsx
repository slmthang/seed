...
export default function LoginPage() {
  return (
    <div className='w-dvw min-h-dvh bg-darkest flex items-center justify-center pb-24'>
        <form className='w-[90%] min-h-[26rem] bg-darker rounded-xl flex flex-col gap-y-6 p-6'>
            <div className='flex flex-col items-center justify-center'>
                ...
                <p className='text-center font-bold'>Sign in to Wallet Inc.</p>
                <p className='text-center text-sm font-extralight'>Welcome back! Log in using email and password below.</p>
            </div>
            ...
            <button formAction={login} className='w-full bg-dark text-sm px-2.5 py-[15px] rounded-lg'>Sign Up</button>
