...
function ClerkField({ name, label, placeholder }: ClerkFieldProps) {
    return (
        <Clerk.Field name={name} className="w-full mb-4">
            <Clerk.Label className="block mb-1">{label}</Clerk.Label>
            <Clerk.Input
                className="w-full pl-4 h-[3rem] flex gap-x-2 justify-center items-center bg-dark rounded-xl"
...
export default function SignInPage() {
    return (
        <SignIn.Root>
            <SignIn.Step
                name="start"
                className="w-[90%] border border-dark bg-darker py-10 px-2 flex justify-center items-center flex-col rounded-xl"
            >
                ...
                <div className="w-[90%]">
                    ...
                    <SignIn.Action
                        submit
                        className="w-[100%] h-[3rem] bg-dark rounded-xl mt-4"
                    >
                        Continue
                    </SignIn.Action>
                </div>
                ...
                <Clerk.Connection
                    name="google"
                    className="w-[90%] h-[3rem] flex gap-x-2 justify-center items-center bg-dark rounded-xl"
                >
                    <GoogleIcon />
                    Sign in with Google
                </Clerk.Connection>
            ...
            <SignIn.Step
                name="verifications"
                className="w-[90%] border border-dark bg-darkest py-10 px-2 flex justify-center items-center flex-col"
            >
            ...
            >
                ...
                <SignIn.Action
                    navigate="previous"
                    className="w-[90%] h-[3rem] bg-dark rounded-xl"
                >
                    Go back
                </SignIn.Action>
            </SignIn.Step>
